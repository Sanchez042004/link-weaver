                    ...
                    <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="relative flex items-center">
                                ...
                                />
                                <button
                                    className="absolute right-4 text-slate-400 dark:text-[#b9a69d] hover:text-primary dark:hover:text-primary transition-colors flex items-center justify-center"
                                    type="button"

...
const Hero: React.FC = () => {
    return (
        <main className="flex-grow pt-24 pb-8 px-6 relative overflow-hidden flex flex-col items-center">
            ...
            <div className="max-w-4xl mx-auto w-full relative z-10 flex flex-col items-center text-center">
                ...
                {/* Headline */}
                <h1 className="font-headline text-5xl md:text-[64px] leading-[1.1] font-semibold tracking-[-0.03em] text-text-primary mb-6 max-w-3xl">
                    shorten. track. done.
                </h1>
                ...
                {/* Developer Info */}
                <div className="mt-16 pt-8 border-t border-border-primary w-full flex flex-col items-center">
                    <p className="text-[11px] font-headline font-semibold uppercase tracking-widest text-[#8a8a8a] mb-6">Developed by Andrés</p>
